...
echo "\"on_sale_items\", \"on_sale_date\"";
echo "<br>";
...
// Decode because it could have html we want to render. Such as anchor tags for
// image links
echo html_entity_decode(shell_exec("
    mysql --html -u '$username' -p'$password' << EOF
    use $db;
    $query;
EOF
  "));
